        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Availability = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonorName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectUpdates_AspNetUsers_PostedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Donations_ReliefProjectId_DonatedAt",
                table: "Donations",
                columns: new[] { "ReliefProjectId", "DonatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectUpdates_ReliefProjectId_PostedAt",
                table: "ProjectUpdates",
                columns: new[] { "ReliefProjectId", "PostedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_TaxCertificates_CertificateNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Volunteers_RegisteredAt",
                table: "Volunteers",
                column: "RegisteredAt");
